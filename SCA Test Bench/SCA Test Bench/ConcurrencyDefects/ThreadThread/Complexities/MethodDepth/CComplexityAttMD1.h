...
#include <stdio.h>
class CComplexityAttMD1
{
public: 
	CComplexityAttMD1(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
