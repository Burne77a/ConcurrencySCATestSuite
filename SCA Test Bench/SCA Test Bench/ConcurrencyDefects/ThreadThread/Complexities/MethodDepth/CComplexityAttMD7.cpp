...
#include "CComplexityAttMD7.h"

#include "CSemaphoreGuard.h"
#include "CComplexityAttMD3.h"
#include "CSemaphoreGuard.h"
#include "CComplexityAttMD1.h"
...
CComplexityAttMD7::CComplexityAttMD7(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAttMD7::DataRace(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAttMD7::DepthFiveFromRace(const unsigned int value)
{
	DepthFourFromRace(value);
}
void CComplexityAttMD7::DepthFourFromRace(const unsigned int value)
{
	DepthThreeFromRace(value);
}
void CComplexityAttMD7::DepthThreeFromRace(const unsigned int value)
{
	DepthTwoFromRace(value);
}
void CComplexityAttMD7::DepthTwoFromRace(const unsigned int value)
{
	DepthOneFromRace(value);
}

void CComplexityAttMD7::DepthOneFromRace(const unsigned int value)
{
	TheDataRace(value);
}

void CComplexityAttMD7::TheDataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAttMD7::Deadlock(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAttMD7::DepthFiveFromDeadlock(const unsigned int value)
{
	DepthFourFromDeadlock(value);
}
void CComplexityAttMD7::DepthFourFromDeadlock(const unsigned int value)
{
	DepthThreeFromDeadlock(value);
}
void CComplexityAttMD7::DepthThreeFromDeadlock(const unsigned int value)
{
	DepthTwoFromDeadlock(value);
}
void CComplexityAttMD7::DepthTwoFromDeadlock(const unsigned int value)
{
	DepthOneFromDeadlock(value);
}

void CComplexityAttMD7::DepthOneFromDeadlock(const unsigned int value)
{
	TheDeadlock(value);
}

void CComplexityAttMD7::TheDeadlock(const unsigned int value)
{
...
void CComplexityAttMD7::Livelock(const unsigned int value)
{
	DepthFiveFromLivelock(value);
}

void CComplexityAttMD7::DepthFiveFromLivelock(const unsigned int value)
{
	DepthFourFromLivelock(value);
}
void CComplexityAttMD7::DepthFourFromLivelock(const unsigned int value)
{
	DepthThreeFromLivelock(value);
}
void CComplexityAttMD7::DepthThreeFromLivelock(const unsigned int value)
{
	DepthTwoFromLivelock(value);
}
void CComplexityAttMD7::DepthTwoFromLivelock(const unsigned int value)
{
	DepthOneFromLivelock(value);
}
	
void CComplexityAttMD7::DepthOneFromLivelock(const unsigned int value)
{
	TheLivelock(value);
}

void CComplexityAttMD7::TheLivelock(const unsigned int value)
{
...
void CComplexityAttMD7::BlockingSuspension(const unsigned int value)
{
	DepthFiveFromBlockingSuspension(value);
}
void CComplexityAttMD7::DepthFiveFromBlockingSuspension(const unsigned int value)
{
	DepthFourFromBlockingSuspension(value);
}
void CComplexityAttMD7::DepthFourFromBlockingSuspension(const unsigned int value)
{
	DepthThreeFromBlockingSuspension(value);
}
void CComplexityAttMD7::DepthThreeFromBlockingSuspension(const unsigned int value)
{
	DepthTwoFromBlockingSuspension(value);
}
void CComplexityAttMD7::DepthTwoFromBlockingSuspension(const unsigned int value)
{
	DepthOneFromBlockingSuspension(value);
}
void CComplexityAttMD7::DepthOneFromBlockingSuspension(const unsigned int value)
{
	TheBlockingSuspension(value);
}

void CComplexityAttMD7::TheBlockingSuspension(const unsigned int value)
{
...
void CComplexityAttMD7::AtomicityViolation(const unsigned int value)
{
	DepthFiveFromAtomicityViolation(value);
}
void CComplexityAttMD7::DepthFiveFromAtomicityViolation(const unsigned int value)
{
	DepthFourFromAtomicityViolation(value);
}
void CComplexityAttMD7::DepthFourFromAtomicityViolation(const unsigned int value)
{
	DepthThreeFromAtomicityViolation(value);
}
void CComplexityAttMD7::DepthThreeFromAtomicityViolation(const unsigned int value)
{
	DepthTwoFromAtomicityViolation(value);
}
void CComplexityAttMD7::DepthTwoFromAtomicityViolation(const unsigned int value)
{
	DepthOneFromAtomicityViolation(value);
}
void CComplexityAttMD7::DepthOneFromAtomicityViolation(const unsigned int value)
{
	TheAtomicityViolation(value);
}
void CComplexityAttMD7::TheAtomicityViolation(const unsigned int value)
{
	//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAttMD7::OrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthFiveFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAttMD7::DepthFiveFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthFourFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAttMD7::DepthFourFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthThreeFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAttMD7::DepthThreeFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthTwoFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAttMD7::DepthTwoFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAttMD7::DepthOneFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	TheOrderViolationAssumedFirstExecution(value);
}

void CComplexityAttMD7::TheOrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAttMD7::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthFiveFromOrderViolationAssumedSecondExecution(value);
}

void CComplexityAttMD7::DepthFiveFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthFourFromOrderViolationAssumedSecondExecution(value);
}
void CComplexityAttMD7::DepthFourFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthThreeFromOrderViolationAssumedSecondExecution(value);
}
void CComplexityAttMD7::DepthThreeFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthTwoFromOrderViolationAssumedSecondExecution(value);
}
void CComplexityAttMD7::DepthTwoFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}

void CComplexityAttMD7::DepthOneFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	TheOrderViolationAssumedSecondExecution(value);
}

void CComplexityAttMD7::TheOrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
