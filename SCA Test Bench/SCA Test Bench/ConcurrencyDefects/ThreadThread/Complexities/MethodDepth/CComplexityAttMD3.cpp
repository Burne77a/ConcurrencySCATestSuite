...
CComplexityAttMD3::CComplexityAttMD3(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAttMD3::DataRace(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAttMD3::DepthOneFromRace(const unsigned int value)
{
	TheDataRace(value);
}

void CComplexityAttMD3::TheDataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAttMD3::Deadlock(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAttMD3::DepthOneFromDeadlock(const unsigned int value)
{
	TheDeadlock(value);
}

void CComplexityAttMD3::TheDeadlock(const unsigned int value)
{
...
void CComplexityAttMD3::Livelock(const unsigned int value)
{
	DepthOneFromLivelock(value);
}
	
void CComplexityAttMD3::DepthOneFromLivelock(const unsigned int value)
{
	TheLivelock(value);
}

void CComplexityAttMD3::TheLivelock(const unsigned int value)
{
...
void CComplexityAttMD3::BlockingSuspension(const unsigned int value)
{
	DepthOneFromBlockingSuspension(value);
}
void CComplexityAttMD3::DepthOneFromBlockingSuspension(const unsigned int value)
{
	TheBlockingSuspension(value);
}

void CComplexityAttMD3::TheBlockingSuspension(const unsigned int value)
{
...
void CComplexityAttMD3::AtomicityViolation(const unsigned int value)
{
	DepthOneFromAtomicityViolation(value);
}
void CComplexityAttMD3::DepthOneFromAtomicityViolation(const unsigned int value)
{
	TheAtomicityViolation(value);
}

void CComplexityAttMD3::TheAtomicityViolation(const unsigned int value)
{
//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAttMD3::OrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}

void CComplexityAttMD3::DepthOneFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	TheOrderViolationAssumedFirstExecution(value);
}

void CComplexityAttMD3::TheOrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAttMD3::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedSecondExecution(value);
}

void CComplexityAttMD3::DepthOneFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	TheOrderViolationAssumedSecondExecution(value);
}

void CComplexityAttMD3::TheOrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
