...
class CComplexityAttMD7
{
public: 
	CComplexityAttMD7(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
{
public:
	CComplexityAttMD7(DATA_STRUCTURE_X1 & referenceToStructureExposedToRace);
	void DataRace(const unsigned int value);
	static const unsigned int DO_RACE = 1U;
private:
	void DepthFiveFromRace(const unsigned int value);
