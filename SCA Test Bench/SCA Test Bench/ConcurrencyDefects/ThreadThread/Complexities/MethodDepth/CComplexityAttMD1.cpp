...
CComplexityAttMD1::CComplexityAttMD1(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAttMD1::DataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAttMD1::Deadlock(const unsigned int value)
{
...
void CComplexityAttMD1::Livelock(const unsigned int value)
{
...
void CComplexityAttMD1::BlockingSuspension(const unsigned int value)
{
...
void CComplexityAttMD1::AtomicityViolation(const unsigned int value)
{
	//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAttMD1::OrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAttMD1::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
