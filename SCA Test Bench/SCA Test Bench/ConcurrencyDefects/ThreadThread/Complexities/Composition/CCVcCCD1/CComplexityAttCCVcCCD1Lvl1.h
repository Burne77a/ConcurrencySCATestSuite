...
class CComplexityAttCCVcCCD1Lvl1
{
public:
	CComplexityAttCCVcCCD1Lvl1(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAttCCVcCCD1Lvl0 m_lvl0;
};