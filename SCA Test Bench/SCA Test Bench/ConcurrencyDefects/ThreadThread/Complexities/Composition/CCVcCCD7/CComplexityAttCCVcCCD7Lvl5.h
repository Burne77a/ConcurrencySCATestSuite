...
class CComplexityAttCCVcCCD7Lvl5
{
public:
	CComplexityAttCCVcCCD7Lvl5(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAttCCVcCCD7Lvl4 m_lvl4;
};