...
class CComplexityAttCCVcCCD7Lvl6
{
public:
	CComplexityAttCCVcCCD7Lvl6(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAttCCVcCCD7Lvl5 m_lvl5;
};