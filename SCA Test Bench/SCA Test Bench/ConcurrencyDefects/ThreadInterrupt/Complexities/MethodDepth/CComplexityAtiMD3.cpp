...
CComplexityAtiMD3::CComplexityAtiMD3(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAtiMD3::DataRace(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAtiMD3::DepthOneFromRace(const unsigned int value)
{
	TheDataRace(value);
}

void CComplexityAtiMD3::TheDataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAtiMD3::Deadlock(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAtiMD3::DepthOneFromDeadlock(const unsigned int value)
{
	TheDeadlock(value);
}

void CComplexityAtiMD3::TheDeadlock(const unsigned int value)
{
...
void CComplexityAtiMD3::Livelock(const unsigned int value)
{
	DepthOneFromLivelock(value);
}
	
void CComplexityAtiMD3::DepthOneFromLivelock(const unsigned int value)
{
	TheLivelock(value);
}

void CComplexityAtiMD3::TheLivelock(const unsigned int value)
{
...
void CComplexityAtiMD3::BlockingSuspension(const unsigned int value)
{
	DepthOneFromBlockingSuspension(value);
}
void CComplexityAtiMD3::DepthOneFromBlockingSuspension(const unsigned int value)
{
	TheBlockingSuspension(value);
}

void CComplexityAtiMD3::TheBlockingSuspension(const unsigned int value)
{
...
void CComplexityAtiMD3::AtomicityViolation(const unsigned int value)
{
	DepthOneFromAtomicityViolation(value);
}
void CComplexityAtiMD3::DepthOneFromAtomicityViolation(const unsigned int value)
{
	TheAtomicityViolation(value);
}

void CComplexityAtiMD3::TheAtomicityViolation(const unsigned int value)
{
//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAtiMD3::OrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}

void CComplexityAtiMD3::DepthOneFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	TheOrderViolationAssumedFirstExecution(value);
}

void CComplexityAtiMD3::TheOrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAtiMD3::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedSecondExecution(value);
}

void CComplexityAtiMD3::DepthOneFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	TheOrderViolationAssumedSecondExecution(value);
}

void CComplexityAtiMD3::TheOrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
