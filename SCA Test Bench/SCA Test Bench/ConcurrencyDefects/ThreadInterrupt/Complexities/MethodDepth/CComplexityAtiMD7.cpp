...
#include "CComplexityAtiMD7.h"

#include "CSemaphoreGuard.h"
#include "CComplexityAtiMD3.h"
#include "CSemaphoreGuard.h"
...
CComplexityAtiMD7::CComplexityAtiMD7(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAtiMD7::DataRace(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAtiMD7::DepthFiveFromRace(const unsigned int value)
{
	DepthFourFromRace(value);
}
void CComplexityAtiMD7::DepthFourFromRace(const unsigned int value)
{
	DepthThreeFromRace(value);
}
void CComplexityAtiMD7::DepthThreeFromRace(const unsigned int value)
{
	DepthTwoFromRace(value);
}
void CComplexityAtiMD7::DepthTwoFromRace(const unsigned int value)
{
	DepthOneFromRace(value);
}

void CComplexityAtiMD7::DepthOneFromRace(const unsigned int value)
{
	TheDataRace(value);
}

void CComplexityAtiMD7::TheDataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAtiMD7::Deadlock(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAtiMD7::DepthFiveFromDeadlock(const unsigned int value)
{
	DepthFourFromDeadlock(value);
}
void CComplexityAtiMD7::DepthFourFromDeadlock(const unsigned int value)
{
	DepthThreeFromDeadlock(value);
}
void CComplexityAtiMD7::DepthThreeFromDeadlock(const unsigned int value)
{
	DepthTwoFromDeadlock(value);
}
void CComplexityAtiMD7::DepthTwoFromDeadlock(const unsigned int value)
{
	DepthOneFromDeadlock(value);
}

void CComplexityAtiMD7::DepthOneFromDeadlock(const unsigned int value)
{
	TheDeadlock(value);
}

void CComplexityAtiMD7::TheDeadlock(const unsigned int value)
{
...
void CComplexityAtiMD7::Livelock(const unsigned int value)
{
	DepthFiveFromLivelock(value);
}

void CComplexityAtiMD7::DepthFiveFromLivelock(const unsigned int value)
{
	DepthFourFromLivelock(value);
}
void CComplexityAtiMD7::DepthFourFromLivelock(const unsigned int value)
{
	DepthThreeFromLivelock(value);
}
void CComplexityAtiMD7::DepthThreeFromLivelock(const unsigned int value)
{
	DepthTwoFromLivelock(value);
}
void CComplexityAtiMD7::DepthTwoFromLivelock(const unsigned int value)
{
	DepthOneFromLivelock(value);
}
	
void CComplexityAtiMD7::DepthOneFromLivelock(const unsigned int value)
{
	TheLivelock(value);
}

void CComplexityAtiMD7::TheLivelock(const unsigned int value)
{
...
void CComplexityAtiMD7::BlockingSuspension(const unsigned int value)
{
	DepthFiveFromBlockingSuspension(value);
}
void CComplexityAtiMD7::DepthFiveFromBlockingSuspension(const unsigned int value)
{
	DepthFourFromBlockingSuspension(value);
}
void CComplexityAtiMD7::DepthFourFromBlockingSuspension(const unsigned int value)
{
	DepthThreeFromBlockingSuspension(value);
}
void CComplexityAtiMD7::DepthThreeFromBlockingSuspension(const unsigned int value)
{
	DepthTwoFromBlockingSuspension(value);
}
void CComplexityAtiMD7::DepthTwoFromBlockingSuspension(const unsigned int value)
{
	DepthOneFromBlockingSuspension(value);
}
void CComplexityAtiMD7::DepthOneFromBlockingSuspension(const unsigned int value)
{
	TheBlockingSuspension(value);
}

void CComplexityAtiMD7::TheBlockingSuspension(const unsigned int value)
{
...
void CComplexityAtiMD7::AtomicityViolation(const unsigned int value)
{
	DepthFiveFromAtomicityViolation(value);
}
void CComplexityAtiMD7::DepthFiveFromAtomicityViolation(const unsigned int value)
{
	DepthFourFromAtomicityViolation(value);
}
void CComplexityAtiMD7::DepthFourFromAtomicityViolation(const unsigned int value)
{
	DepthThreeFromAtomicityViolation(value);
}
void CComplexityAtiMD7::DepthThreeFromAtomicityViolation(const unsigned int value)
{
	DepthTwoFromAtomicityViolation(value);
}
void CComplexityAtiMD7::DepthTwoFromAtomicityViolation(const unsigned int value)
{
	DepthOneFromAtomicityViolation(value);
}
void CComplexityAtiMD7::DepthOneFromAtomicityViolation(const unsigned int value)
{
	TheAtomicityViolation(value);
}
void CComplexityAtiMD7::TheAtomicityViolation(const unsigned int value)
{
	//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAtiMD7::OrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthFiveFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAtiMD7::DepthFiveFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthFourFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAtiMD7::DepthFourFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthThreeFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAtiMD7::DepthThreeFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthTwoFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAtiMD7::DepthTwoFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}
void CComplexityAtiMD7::DepthOneFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	TheOrderViolationAssumedFirstExecution(value);
}

void CComplexityAtiMD7::TheOrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAtiMD7::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthFiveFromOrderViolationAssumedSecondExecution(value);
}

void CComplexityAtiMD7::DepthFiveFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthFourFromOrderViolationAssumedSecondExecution(value);
}
void CComplexityAtiMD7::DepthFourFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthThreeFromOrderViolationAssumedSecondExecution(value);
}
void CComplexityAtiMD7::DepthThreeFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthTwoFromOrderViolationAssumedSecondExecution(value);
}
void CComplexityAtiMD7::DepthTwoFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}

void CComplexityAtiMD7::DepthOneFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	TheOrderViolationAssumedSecondExecution(value);
}

void CComplexityAtiMD7::TheOrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
