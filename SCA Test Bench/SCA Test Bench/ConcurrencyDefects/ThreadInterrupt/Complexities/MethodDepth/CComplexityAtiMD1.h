...
#include <stdio.h>
class CComplexityAtiMD1
{
public: 
	CComplexityAtiMD1(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
