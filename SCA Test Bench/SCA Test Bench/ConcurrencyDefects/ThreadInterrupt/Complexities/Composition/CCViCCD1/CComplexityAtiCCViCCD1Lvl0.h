...
class IComplexityAttCCViCCD1Lvl0
{
public:
...
class CComplexityAtiCCViCCD1Lvl0 : public IComplexityAttCCViCCD1Lvl0
{
public: 
	CComplexityAtiCCViCCD1Lvl0(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
		DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableGuardProtected, DATA_STRUCTURE_X1 & referenceToAtomicityExposedVariable);
	virtual void DataRace(const unsigned int value);
	virtual void Deadlock(const unsigned int value);
	virtual void Livelock(const unsigned int value);
	virtual void BlockingSuspension(const unsigned int value);
	virtual void AtomicityViolation(const unsigned int value);
	virtual void OrderViolationAssumedFirstExecution(const unsigned int value);
	virtual void OrderViolationAssumedSecondExecution(const unsigned int value);
