...
class CComplexityAtiCCVcCCD7Lvl2
{
public:
	CComplexityAtiCCVcCCD7Lvl2(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAtiCCVcCCD7Lvl1 m_lvl1;
};