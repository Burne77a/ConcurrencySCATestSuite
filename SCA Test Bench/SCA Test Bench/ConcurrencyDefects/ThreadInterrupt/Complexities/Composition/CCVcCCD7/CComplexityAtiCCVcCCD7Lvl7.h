...
class CComplexityAtiCCVcCCD7Lvl7
{
public:
	CComplexityAtiCCVcCCD7Lvl7(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAtiCCVcCCD7Lvl6 m_lvl6;
};