...
class CComplexityAtiCCVcCCD7Lvl3
{
public:
	CComplexityAtiCCVcCCD7Lvl3(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAtiCCVcCCD7Lvl2 m_lvl2;
};