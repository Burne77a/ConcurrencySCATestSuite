...
CComplexityAiiCCViCCD1Lvl0::CComplexityAiiCCViCCD1Lvl0(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAiiCCViCCD1Lvl0::DataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAiiCCViCCD1Lvl0::Deadlock(const unsigned int value)
{
...
void CComplexityAiiCCViCCD1Lvl0::Livelock(const unsigned int value)
{
...
void CComplexityAiiCCViCCD1Lvl0::BlockingSuspension(const unsigned int value)
{
...
void CComplexityAiiCCViCCD1Lvl0::AtomicityViolation(const unsigned int value)
{
	//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAiiCCViCCD1Lvl0::OrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAiiCCViCCD1Lvl0::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
