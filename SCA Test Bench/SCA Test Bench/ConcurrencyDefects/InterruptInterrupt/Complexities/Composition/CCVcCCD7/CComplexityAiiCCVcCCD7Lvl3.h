...
class CComplexityAiiCCVcCCD7Lvl3
{
public:
	CComplexityAiiCCVcCCD7Lvl3(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAiiCCVcCCD7Lvl2 m_lvl2;
};