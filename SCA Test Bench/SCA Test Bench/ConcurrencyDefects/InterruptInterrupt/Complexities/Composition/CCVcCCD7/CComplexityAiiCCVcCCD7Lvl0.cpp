...
CComplexityAiiCCVcCCD7Lvl0::CComplexityAiiCCVcCCD7Lvl0(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAiiCCVcCCD7Lvl0::DataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAiiCCVcCCD7Lvl0::Deadlock(const unsigned int value)
{
...
void CComplexityAiiCCVcCCD7Lvl0::Livelock(const unsigned int value)
{
...
void CComplexityAiiCCVcCCD7Lvl0::BlockingSuspension(const unsigned int value)
{
...
void CComplexityAiiCCVcCCD7Lvl0::AtomicityViolation(const unsigned int value)
{
	//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAiiCCVcCCD7Lvl0::OrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAiiCCVcCCD7Lvl0::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
