...
class CComplexityAiiCCVcCCD7Lvl7
{
public:
	CComplexityAiiCCVcCCD7Lvl7(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAiiCCVcCCD7Lvl6 m_lvl6;
};