...
class CComplexityAiiCCVcCCD3Lvl3
{
public:
	CComplexityAiiCCVcCCD3Lvl3(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable, DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
private:
	CComplexityAiiCCVcCCD3Lvl2 m_lvl2;
};