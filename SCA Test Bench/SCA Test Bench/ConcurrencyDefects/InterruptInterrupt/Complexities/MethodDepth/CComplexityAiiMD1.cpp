...
CComplexityAiiMD1::CComplexityAiiMD1(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAiiMD1::DataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAiiMD1::Deadlock(const unsigned int value)
{
...
void CComplexityAiiMD1::Livelock(const unsigned int value)
{
...
void CComplexityAiiMD1::BlockingSuspension(const unsigned int value)
{
...
void CComplexityAiiMD1::AtomicityViolation(const unsigned int value)
{
	//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAiiMD1::OrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAiiMD1::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
