...
CComplexityAiiMD3::CComplexityAiiMD3(DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariable,DATA_STRUCTURE_X1 & referenceToDataRaceExposedVariableSemProtected, 
...
void CComplexityAiiMD3::DataRace(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAiiMD3::DepthOneFromRace(const unsigned int value)
{
	TheDataRace(value);
}

void CComplexityAiiMD3::TheDataRace(const unsigned int value)
{
	//ACg. Global variable. 
	if((value % 20) == DO_RACE)
	{
...
void CComplexityAiiMD3::Deadlock(const unsigned int value)
{
	if ((value % DO_RACE) == 0)
	{
...
void CComplexityAiiMD3::DepthOneFromDeadlock(const unsigned int value)
{
	TheDeadlock(value);
}

void CComplexityAiiMD3::TheDeadlock(const unsigned int value)
{
...
void CComplexityAiiMD3::Livelock(const unsigned int value)
{
	DepthOneFromLivelock(value);
}
	
void CComplexityAiiMD3::DepthOneFromLivelock(const unsigned int value)
{
	TheLivelock(value);
}

void CComplexityAiiMD3::TheLivelock(const unsigned int value)
{
...
void CComplexityAiiMD3::BlockingSuspension(const unsigned int value)
{
	DepthOneFromBlockingSuspension(value);
}
void CComplexityAiiMD3::DepthOneFromBlockingSuspension(const unsigned int value)
{
	TheBlockingSuspension(value);
}

void CComplexityAiiMD3::TheBlockingSuspension(const unsigned int value)
{
...
void CComplexityAiiMD3::AtomicityViolation(const unsigned int value)
{
	DepthOneFromAtomicityViolation(value);
}
void CComplexityAiiMD3::DepthOneFromAtomicityViolation(const unsigned int value)
{
	TheAtomicityViolation(value);
}

void CComplexityAiiMD3::TheAtomicityViolation(const unsigned int value)
{
//ACd complexity, access direct. 
	//Native OS call.
...
void CComplexityAiiMD3::OrderViolationAssumedFirstExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedFirstExecution(value);
}

void CComplexityAiiMD3::DepthOneFromOrderViolationAssumedFirstExecution(const unsigned int value)
{
	TheOrderViolationAssumedFirstExecution(value);
}

void CComplexityAiiMD3::TheOrderViolationAssumedFirstExecution(const unsigned int value)
{
...
void CComplexityAiiMD3::OrderViolationAssumedSecondExecution(const unsigned int value)
{
	DepthOneFromOrderViolationAssumedSecondExecution(value);
}

void CComplexityAiiMD3::DepthOneFromOrderViolationAssumedSecondExecution(const unsigned int value)
{
	TheOrderViolationAssumedSecondExecution(value);
}

void CComplexityAiiMD3::TheOrderViolationAssumedSecondExecution(const unsigned int value)
{
	if((value % 10) == DO_ORDER_VIOLATION)
	{
		int buffer[100];
